...
This module interacts with a backend service (assumed to be running at `http://138.197.125.251:8085/api` or a configurable `SERVER_URL`) that wraps the Meteora SDK to simplify client-side interactions.
